...
class vswitch_hostStub(object):
  ...
  def __init__(self, channel):
    ...
    self.rpc_get_vswitch_host = channel.unary_unary(
        ...
        request_serializer=vswitch__host__pb2.req_host_key.SerializeToString,
        response_deserializer=vswitch__host__pb2.res_vswitch_host.FromString,
        )
    self.rpc_list_vswitch_hosts = channel.stream_stream(
        '/vswitch_host/rpc_list_vswitch_hosts',
        request_serializer=vswitch__host__pb2.req_host_key.SerializeToString,
        response_deserializer=vswitch__host__pb2.res_vswitch_host.FromString,
        )
...
def add_vswitch_hostServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'rpc_get_vswitch_host': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=vswitch__host__pb2.req_host_key.FromString,
          response_serializer=vswitch__host__pb2.res_vswitch_host.SerializeToString,
      ),
      'rpc_list_vswitch_hosts': grpc.stream_stream_rpc_method_handler(
          servicer.rpc_list_vswitch_hosts,
          request_deserializer=vswitch__host__pb2.req_host_key.FromString,
          response_serializer=vswitch__host__pb2.res_vswitch_host.SerializeToString,
      ),
