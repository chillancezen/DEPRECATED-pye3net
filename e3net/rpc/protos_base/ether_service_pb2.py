...
_REQ_SERVICE_CREATE_SPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tenant_id', full_name='req_service_create_spec.tenant_id', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='initial_lanzones', full_name='req_service_create_spec.initial_lanzones', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ban_hosts', full_name='req_service_create_spec.ban_hosts', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ban_lanzones', full_name='req_service_create_spec.ban_lanzones', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ban_interfaces', full_name='req_service_create_spec.ban_interfaces', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_synced', full_name='req_service_create_spec.is_synced', index=8,
...
_REQ_LAN_SERVICE_UPDATE_SPEC = _descriptor.Descriptor(
  name='req_lan_service_update_spec',
  full_name='req_lan_service_update_spec',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='service_id', full_name='req_lan_service_update_spec.service_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operation', full_name='req_lan_service_update_spec.operation', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ban_hosts', full_name='req_lan_service_update_spec.ban_hosts', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ban_lanzones', full_name='req_lan_service_update_spec.ban_lanzones', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ban_interfaces', full_name='req_lan_service_update_spec.ban_interfaces', index=4,
      number=5, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='initial_lanzones', full_name='req_lan_service_update_spec.initial_lanzones', index=5,
      number=6, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_synced', full_name='req_lan_service_update_spec.is_synced', index=6,
...
_REQ_SERVICE_DELETE_SPEC = _descriptor.Descriptor(
  name='req_service_delete_spec',
  full_name='req_service_delete_spec',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='service_ids', full_name='req_service_delete_spec.service_ids', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_synced', full_name='req_service_delete_spec.is_synced', index=1,
...
DESCRIPTOR.message_types_by_name['req_lan_service_update_spec'] = _REQ_LAN_SERVICE_UPDATE_SPEC
DESCRIPTOR.message_types_by_name['req_service_delete_spec'] = _REQ_SERVICE_DELETE_SPEC
...
req_lan_service_update_spec = _reflection.GeneratedProtocolMessageType('req_lan_service_update_spec', (_message.Message,), dict(
  DESCRIPTOR = _REQ_LAN_SERVICE_UPDATE_SPEC,
  __module__ = 'ether_service_pb2'
  # @@protoc_insertion_point(class_scope:req_lan_service_update_spec)
  ))
_sym_db.RegisterMessage(req_lan_service_update_spec)

req_service_delete_spec = _reflection.GeneratedProtocolMessageType('req_service_delete_spec', (_message.Message,), dict(
  DESCRIPTOR = _REQ_SERVICE_DELETE_SPEC,
  __module__ = 'ether_service_pb2'
  # @@protoc_insertion_point(class_scope:req_service_delete_spec)
  ))
_sym_db.RegisterMessage(req_service_delete_spec)
...
_ETHER_SERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=5,
    containing_service=None,
    input_type=_REQ_SERVICE_DELETE_SPEC,
    output_type=common__pb2._NULL,
    options=None,
  ),
  _descriptor.MethodDescriptor(
    name='rpc_taslflow_update_ether_lan_service',
    full_name='ether_service.rpc_taslflow_update_ether_lan_service',
    index=6,
    containing_service=None,
    input_type=_REQ_LAN_SERVICE_UPDATE_SPEC,
    output_type=common__pb2._NULL,
    options=None,
  ),
  _descriptor.MethodDescriptor(
