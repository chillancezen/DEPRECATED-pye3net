...
'''
root_key is 'ether_service_vlan'
while sub_key is the uuid of the ether_service_vlan
'''

default_user_timeout=60
root_key='ether_service_vlan'

def invt_register_vswitch_ether_service_vlan(fields_create_dict,user_sync=False,user_timeout=default_user_timeout):
...
def invt_unregister_vswitch_ether_service_vlan(vlan_uuid,user_sync=False,user_timeout=default_user_timeout):
    sub_key=vlan_uuid
    base=get_inventory_base()
    assert(base)
